...
public class Loop2 {
    ...
    /**
     * Метод проверяет, является ли значение типа String целым числом, если да - разбивает его на массив символов char.
     ...
     * Метод проверяет, является ли значение типа String целым числом, если да - разбивает его циклом на массив цифр int.
