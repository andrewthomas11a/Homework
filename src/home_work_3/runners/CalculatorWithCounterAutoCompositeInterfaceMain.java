...
public class CalculatorWithCounterAutoCompositeInterfaceMain {
    public static void main(String[] args) {
        ...
        double result1 = calc71.sum(4.1,
                                calc71.mult(15, 7),
                                calc71.power(calc71.div(28, 5), 2));
        ...
        double result2 = calc72.sum(4.1,
                                calc72.mult(15, 7),
                                calc72.power(calc72.div(28, 5), 2));
        ...
        double result3 = calc73.sum(4.1,
                                calc73.mult(15, 7),
                                calc73.power(calc73.div(28, 5), 2));
