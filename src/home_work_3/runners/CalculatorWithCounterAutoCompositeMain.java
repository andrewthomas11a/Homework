...
public class CalculatorWithCounterAutoCompositeMain {
    public static void main(String[] args) {
        ...
        double result1 = calc61.sum(4.1, calc61.mult(15, 7), calc61.power(calc61.div(28, 5), 2));
        ...
        double result2 = calc62.sum(4.1, calc62.mult(15, 7), calc62.power(calc62.div(28, 5), 2));
        ...
        double result3 = calc63.sum(4.1, calc63.mult(15, 7), calc63.power(calc63.div(28, 5), 2));
