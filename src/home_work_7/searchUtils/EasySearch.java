...
public class EasySearch implements ISearchEngine {
    ...
    // слово "привет-привет" будет воспринято как 2 слова "привет"

    // это не регулярное выражение, это тупо строка со всеми возможными символами, не являющимися буквой или цифрой
